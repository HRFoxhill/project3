...
module.exports = function(expressApp) {
  ...
  passport.use(require('./auth-strategies/local'))
...
const serializeUser = function(user, done) {
  ...
  //user.save();
  done(null, user[0]._id);//save the user's id in the cookie. This is how Passport wants you to do this. 
}
